...
class _ConverterPageState extends State<ConverterPage> {
  ...
  Future<void> _getCurrecyHistories() async{
    ...
    setState(() {
      _currencyHistories.add(AppHelpers.getCurrentCurrency(currentCurrencies, widget.currency));
    });
    }
  }
            ...
            children: [
                ...
                onChanged: (value) {
                  setState(() {
                    ...
                    double.parse(widget.currency.rate ?? '');
                        ...
                        _calculatedSum =
                            double.parse(value) * double.parse(widget.currency.rate ?? '');
                      }
                    }
                  });
                },
              ...
              _isUzsMain
                ...
                AppHelpers.getCurrencyTitleByLocale(
                  ...
                  :  Text('O\'zbekiston so\'mi'),
              SizedBox(height: 40,
              ),
              ListView.builder(itemCount: _currencyHistories.length,
                shrinkWrap: true,
                physics: const NeverScrollableScrollPhysics(),
                itemBuilder: (context, index){
                return CurrencyHistoryItem(currency: _currencyHistories[index], locale: widget.locale);
                }
              ),
